...
flowchart TD
    ...
    NStep3 --> |Eligible| NStep4[Step 4: Fill Form & Submit]
    ...
    Action1 --> Change1[Status: Submitted → Pending Approval]
    Action2 --> Change2[Status: Submitted → Rejected]
    Action3 --> Change3[Status: Pending Approval → Approved]
    Action4 --> Change4[Status: Pending Approval → Rejected]
